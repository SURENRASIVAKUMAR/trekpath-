...
app.get('/api/destinations', (req, res) => {
    const destinations = [
        { name: 'Maldives', image_url: 'https://picsum.photos/id/198/800/600', description: 'Crystal clear waters and white sand beaches.' },
        { name: 'Swiss Alps', image_url: 'https://picsum.photos/id/690/800/600', description: 'Experience the majestic mountains and snowy peaks.' },
        { name: 'Kyoto', image_url: 'https://picsum.photos/id/233/800/600', description: 'Discover ancient temples and beautiful gardens.' },
        { name: 'Santorini', image_url: 'https://picsum.photos/id/573/800/600', description: 'Stunning sunsets and iconic blue dome churches.' }
    ];

      ...
      <div class="item-card">
        ...
        <div class="item-content">
          ...
          <div style="display:flex; gap:10px; margin:10px 0;">
            ...
            <button class="item-btn" onclick="window.location.href='booking.html'"><i class="fas fa-ticket-alt"></i> Book Tour</button>
          </div>
      ...
      <div id="downloadableContent" style="width:100%;">
        ...
        <div class="dash-section card-container">
          <div class="section-head" style="justify-content:space-between;">
            ...
            <div style="display:flex; gap:10px;">
              <button class="util-btn" onclick="showToast('Photo spots overlaid on Map!', 'fa-camera-retro')"><i class="fas fa-camera-retro"></i> Photo Spots</button>
